      ...
      {attachments.length > 0 && (
        <div className="flex flex-wrap gap-2 mb-3">
          {attachments.map((att, idx) => (
            <div key={idx} className="flex items-center gap-2 bg-[#F9FAFB] border border-ink/10 dark:bg-slate-800 dark:border-slate-700 px-3 py-1.5 rounded-md text-sm text-[#344054] dark:text-slate-300">
