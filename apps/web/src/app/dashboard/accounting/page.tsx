                    ...
                    <tr key={doc.id} className="hover:bg-[#F9FAFB] dark:hover:bg-slate-800/30 transition-colors group">
                      ...
                      <td className="px-6 py-4 text-right">
                        <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                      <Link href={`/dashboard/accounting/documents/${doc.id}`} target="_blank" className="p-1.5 text-ink/60 hover:bg-linen dark:hover:bg-slate-700 rounded transition-colors" title="Download PDF">
                              <Download size={16} />
                            </Link>
                            <button onClick={() => window.open(`https://wa.me/?text=Here is the document ${doc.refNumber}: ${window.location.origin}/dashboard/accounting/documents/${doc.id}`, '_blank')} className="p-1.5 text-[#25D366] hover:bg-[#25D366]/10 rounded transition-colors" title="Share via WhatsApp">
                            ...
                            <button onClick={() => window.location.href = `mailto:?subject=Document ${doc.refNumber}&body=Here is the document: ${window.location.origin}/dashboard/accounting/documents/${doc.id}`} className="p-1.5 text-ink/60 hover:bg-linen dark:hover:bg-slate-700 rounded transition-colors" title="Share via Email">
                              <Mail size={16} />
                            </button>
